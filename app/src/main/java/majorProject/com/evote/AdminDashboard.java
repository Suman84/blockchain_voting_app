...
public class AdminDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_viewvotes = findViewById(R.id.viewvotes);
        ...
        button_viewvotes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), ViewVotes.class));
            }
        });
